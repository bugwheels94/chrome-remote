...
export const playVideo = createAsyncThunkPlus(
	"videos/create",
	({ socket, ...options }) => socket.emitPromise("playVideo", options)
);

export const fullscreenVideo = createAsyncThunkPlus(
	"videos/fullscreen",
	({ socket, ...options }) => socket.emitPromise("fullscreenVideo", options)
);
